...
public class CreditNewOpenedAccountofCustomerUtility {
...
//		element.click();
		...
		WebElement ele=driver.findElement(By.xpath("//a[contains(.,'Internet Banking')]"));
		WebElement logbtn= driver.findElement(By.xpath("//li[text()='Login ']"));
		
		
		wUtility.scrollTillEleToBeVisible(driver, ele);
		
		wUtility.mousehoveraction(driver, ele);
		logbtn.click();
		driver.findElement(By.name("customer_id")).sendKeys(internetAccountNumber);
		driver.findElement(By.name("password")).sendKeys(confpassword);
		...
		driver.findElement(By.name("customer_account_no")).sendKeys(internetAccountNumber);
		driver.findElement(By.name("credit_amount")).sendKeys("5000");
		driver.findElement(By.name("credit_btn")).click();
		System.out.println("Amount credited successfully to "+name+"Account");
	}
}
