...
public class DeletecustomernewlycreatedAccount {
	...
	public static void main(String[] args) throws IOException, AWTException 
	{
		...
		//wb.getSheet("sheet1").getRow(10).getCell(1);
		driver.findElement(By.name("submit")).click();
		...
		driver.findElement(By.name("Cust_ac_no")).sendKeys(accountID);
		//String custid = sheet.getRow(12).getCell(1).getStringCellValue();
		driver.findElement(By.name("Cust_ac_Id")).sendKeys(internetAccountNumber);
		driver.findElement(By.name("reason")).sendKeys("Not required");
